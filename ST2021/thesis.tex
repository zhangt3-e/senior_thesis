...
precipitation is only 6$\%$. Looking at Figure~\ref{crudemodel}, we see that
the model precipitation total is lower than the actual precipitation
observed in the Summer of 2018. Furthermore, the precipitation seems to be
more frequent compared to the observed 2018 Summer data.
...
\begin{figure}[t]
  ...
  \caption[Modified run using Summer 2018 climatology]
          {\label{crudermodel}One model run using the 100th percentile
            ...
            precipitation accuracy is only 7\% and the total precipitation
...
Discuss the Figure~\ref{crudesmodel_whole2018} as showing the need to do the
seasonal breakdown.
