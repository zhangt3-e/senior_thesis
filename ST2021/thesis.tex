...
Define the accuracy of model vs. observed. 

Make sure you work on making more intensity as well as longer non-precipitation duration. 

Need to change the parameters that the model takes in. 

How to match the observed total precipitation as well as making more realistic model simulation aka matches observations.
  
Make sure you run the same analysis on the model run to see if the co-efficients are similar. 

Compare the two data sets. 

Try to find the best one, show yourself the average one and the worst one in terms of looking of figure 13. 
What is the percent of complete emptiness, what is the percent of non-precipitation minutes for each dataset? 
