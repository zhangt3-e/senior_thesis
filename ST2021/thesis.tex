...
\begin{figure}[t]
	...
	{\label{crudemodel} One model run using the exponentials calculated from Summer 2018, did some adjustments to get a better model to match the actual summer 2018 run.}
\end{figure}
