...
\begin{table}[b]
	\begin{center}
		\begin{tabular}{l*{11}{c}r}
			...
			\hline
			2017      & \textit{169}  & \textit{-0.61}  & NaN & NaN & NaN & NaN & $\beta $ & $\alpha$ & $\beta $ & $\alpha$  \\
			2018      & 392           & -0.59  & $\beta $ & $\alpha$ & $\beta $ & $\alpha$ & $\beta $ & $\alpha$ & $\beta $ & $\alpha$  \\
			2019      & 308           & -0.54  & $\beta $ & $\alpha$ & $\beta $ & $\alpha$ & $\beta $ & $\alpha$ & $\beta $ & $\alpha$ \\
			2020      & 408           & -0.65   & $\beta $ & $\alpha$ & $\beta $ & $\alpha$ & $\beta $ & $\alpha$ & $\beta $ & $\alpha$ \\
		\end{tabular}
	\end{center}
