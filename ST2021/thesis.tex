...
%At the same time, relative humidity becomes important especially during warmer temperatures, as increases in relative humidity can mean the apparent temperature felt by humans will increase. This is the heat index, in which 
...
\begin{figure}[b]
	...
	season]{\label{p2020} Distribution of precipitation duration
		in 2020, with a breakdown by seasons. The minimum duration is $\tau = 1$~min. %The layout is as in
		%Figure~\ref{p2019}. 
	}
\end{figure}
...
\begin{figure}[t]
	...
	\caption[Histogram of non-precipitation events for 2017 broken down
          ...
          duration in 2017, with a breakdown by seasons. The minimum duration is $\tau = 1$~min. Note that data collection began on 16
