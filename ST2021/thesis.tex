...
Air temperature is just measuring the temperature that the air reaches. 
Atmospheric Pressure is just measuring the air pressure that exists in the area. 
Relative Humidity is the amount of water vapor present relative to the temperature of the air. 
For example, you can have the same amount of water vapor for two parcels 
of air, but if one air parcel is a warmer temperature than the other parcel,
the higher temperature air parcel has a lower relative humidity than the lower 
temperature air parcel, since warmer air can hold more water vapor. 
Rain accumulation or precipitation accumulation just measures the amount of 
precipitation that has fallen from a precipitation event, usually rain or snow. 
...
\begin{figure}[t]
	...
	\caption[Weather Station Data]{\label{daily} This is a daily plot of the parameters that the Vaisala station measures on top of Guyot Hall. }
\end{figure}
\clearpage
\begin{figure}[t]
	\centering
...
As expected, Princeton has four seasons with cold winters and warm summers. At the same time, there is more precipitation in the spring and summer compared to the relative lack of precipitation in the fall and winter.

We also see that relative humidity for Princeton is higher in the months of August to October, whereas the lowest relative humidity seems to be in the months of March and April. % Will add 25-75th percentile range, since I think that would make sense. 

For atmospheric air pressure, the lowest monthly air pressure are found in the months of April and June, while the highest monthly air pressure are found in the month of Feburary. % Again will add 25-75th percentile ranges too, since it would also make sense! 
\clearpage
\begin{figure}[t]
	\centering
	\includegraphics[width=0.675\textwidth]{Figures/RH_clim.png}
	\caption[Climatology of Relative Humidity of Princeton (2017- 2021)]{\label{RH_Clim} Average Climatology for relative humidity for Princeton. }
\end{figure}
\begin{figure}[b]
	\centering
	\includegraphics[width=0.675\textwidth]{Figures/AP_clim.png}
	\caption[Climatology of Air Pressure of Princeton (2017- 2021) ]{\label{AP_Clim}
		A similar graph with \ref{RH_Clim} looking at the anomaly from average air pressure at sea level. }
\end{figure}
\clearpage
