...
% Why? 
Decision tree and linear regression do lack one thing, in which that time does not matter, so I can put in the data in random order and should get the same results. This should not be a case, in which the data is spaced out in time. Thus we try using Neural Networks and Deep Learning. 
\subsection{Method}
