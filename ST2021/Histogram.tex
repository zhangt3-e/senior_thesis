...
\end{figure}
\begin{figure}[h]
\centering \includegraphics[width=0.5\textwidth]{../Figures/nonprecip_hist_5min.png} 
=======
...
\end{figure}
\begin{figure}[h]
\centering \includegraphics[width=0.5\textwidth]{../Figures/inten1mm_season_19.png} 
=======
